<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="profilemain.aspx.cs" Inherits="Admin_profilemain" %>
                    ...
                    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" OnRowEditing="gv1_RowEditing" OnRowUpdating="gv1_RowUpdating" OnRowCancelingEdit="gv1_RowCancelingEdit" OnRowDeleting="gv1_RowDeleting" CssClass="gridview" OnPageIndexChanging="gv1_PageIndexChanging" PageSize="10" AllowPaging="true">
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                 <img src="<%# Eval("image") %>" style="height: 70px; width: 100px; margin-left:10px" />
                            ...
                            <asp:TemplateField>
                                <HeaderStyle CssClass="hdrow" />
                                <HeaderTemplate>
                                    <asp:Label ID="hlbledate" runat="server" Text="Title" Width="550"></asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lbldate" runat="server" Text='<%# Eval("titile") %>'></asp:Label>
                                </ItemTemplate>

                                <EditItemTemplate>
                                    <asp:TextBox ID="inputDate" runat="server" Text='<%# Eval("titile") %>' Width="550"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
