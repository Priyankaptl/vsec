<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Newupdate.aspx.cs" Inherits="Admin_Newupdate" %>
        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="breadcrumb box-title">Add Achievers</h5>
                </div>
                <hr />
                <div class="box-body">
            ...
            <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" OnRowEditing="gv1_RowEditing" OnRowUpdating="gv1_RowUpdating" OnRowCancelingEdit="gv1_RowCancelingEdit" OnRowDeleting="gv1_RowDeleting" CssClass="gridview" OnPageIndexChanging="gv1_PageIndexChanging" PageSize="10" AllowPaging="true">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <HeaderStyle CssClass="hdrow" />
                        <HeaderTemplate>
                            <asp:Label ID="hlbledate" runat="server" Text="News update" Width="800"></asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lbldate" runat="server" Text='<%# Eval("Detalias") %>'></asp:Label>
                        </ItemTemplate>

                        <EditItemTemplate>
                            <asp:TextBox ID="inputDate" runat="server" Text='<%# Eval("Detalias") %>' Width="800"></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:Button ID="btnedit" runat="server" Text="Latest Update" CommandName="Edit" />
