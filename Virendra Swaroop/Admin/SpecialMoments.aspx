<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SpecialMoments.aspx.cs" Inherits="Admin_SpecialMoments" %>
        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="breadcrumb box-title">Add Special Moments</h5>
                </div>
                <hr />
                <div class="box-body">
                ...
                <asp:GridView ID="gv1" runat="server" AutoGenerateColumns="false" OnRowEditing="gv1_RowEditing" OnRowUpdating="gv1_RowUpdating" OnRowCancelingEdit="gv1_RowCancelingEdit" OnRowDeleting="gv1_RowDeleting" CssClass="gridview" OnPageIndexChanging="gv1_PageIndexChanging" PageSize="10" AllowPaging="true">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <img src="<%# Eval("Images") %>" style="height: 70px; width: 100px; margin-left:10px" />
                        ...
                        <asp:TemplateField>
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="inputDate" runat="server" Text='<%# Eval("Name") %>' Width="550"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
