...
<H2> Successful Offline Transactions </H2>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Enter keywords to filter records...">
...
$a4="NEFT";
$a5="CASH";
$sql = "SELECT * FROM student where status='$a1' OR status='$a2' OR status='$a3' OR status='$a4' OR status='$a5'";
...
<td>". $row["status"]. "</td><td>". $row["DDATE"]. "</td>
</tr>";
}
